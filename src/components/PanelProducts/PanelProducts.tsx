...
function PanelProducts() {
    ...
    const activeDeleteButton =
        "invert(71%) sepia(51%) saturate(6983%) hue-rotate(347deg) brightness(106%) contrast(101%)";
    const inactiveDeleteButton = "invert(96%) sepia(0%) saturate(2%) hue-rotate(126deg) brightness(86%) contrast(91%)";

    const productModalOpen = () => setProductModal(true);
    ...
    return isLoading === true ? (
        ...
        <div className="adminpanelproducts flex-column">
            {productModal === true && (
                <Modal productModalClose={productModalClose} saveData={saveData} refreshData={refreshData} />
            )}
            ...
            <div className="adminpanel__topbar flex-row">
                ...
                <div className="adminpanel__topbar--right flex-row">
                    ...
                    <button onClick={productModalOpen}>Agregar producto</button>
                </div>
            </div>
                ...
                {Object.keys(selectedProduct).length === 0 ? (
                    ...
                    <div className="content__details flex-column">
                        ...
                        <div className="details__photo flex-row">
                            <div
                                className="details__photo--photo"
                        ...
                        <div className="details__delete flex-row">
                            ...
                            >
                                <img src="https://cdn-icons-png.flaticon.com/512/542/542724.png" alt="" /> Eliminar
                                producto
                            </button>
                        </div>
                    </div>
                    ...
                    {Object.keys(selectedProduct).length === 0 ? (
                        ...
                        <div className="content__stock flex-column">
                            ...
                            <button className="flex-row">
                                <img
                                    src="https://cdn2.iconfinder.com/data/icons/picol-vector/32/accept-512.png"
                                    alt=""
                                />
                                Modificar producto
                            </button>
